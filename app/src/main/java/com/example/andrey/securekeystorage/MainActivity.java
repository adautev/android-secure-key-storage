...
public class MainActivity extends AppCompatActivity {
    ...
    public void encrypt(View view) throws InvalidKeyException, UnsupportedEncodingException, BadPaddingException, IllegalBlockSizeException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException {
        final Cipher cipher = Cipher.getInstance("AES/GCM/NoPadding");
        cipher.init(Cipher.ENCRYPT_MODE, this.key);
        this.encryptedPayload = cipher.doFinal("Hello world!".getBytes("UTF-8"));
        this.setIV(cipher.getIV());
        ((TextView)findViewById(R.id.text)).setText("Content encrypted...");
    ...
    public void decrypt(View view) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException, BadPaddingException, IllegalBlockSizeException, InvalidAlgorithmParameterException {
        ...
        ((TextView)findViewById(R.id.text)).setText("Decrypted payload:" + decryptedPayload);
    }
